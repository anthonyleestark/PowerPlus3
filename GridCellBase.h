...
//		Description:	Grid cell base class header file
...
public:
    ...
    virtual void SetHTextClr(COLORREF /* clr */)             = 0 ;
    virtual void SetHBackClr(COLORREF /* clr */)             = 0 ;
    ...
    virtual COLORREF   GetHTextClr()   const                = 0 ;
    virtual COLORREF   GetHBackClr()   const                = 0 ;
