...
#define IDS_REGKEY_DBTEST_DUMMYTEST						(STRINGID_REGKEY_GLBDATA+20)
#define IDS_REGKEY_DBTEST_DEBUGMODE						(STRINGID_REGKEY_GLBDATA+21)
#define IDS_REGKEY_DBTEST_DBLOGOUTPUT					(STRINGID_REGKEY_GLBDATA+22)
#define IDS_REGKEY_DBTEST_TESTFEATURE					(STRINGID_REGKEY_GLBDATA+23)
