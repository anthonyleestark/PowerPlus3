/**
 * @file		AppMacros.h
 * @brief		Define application base macros
...
#define SM_APP_SHOW_REMINDER_BALLOON_TIP			(SM_APP_MESSAGE + 9)
#define SM_APP_DEBUG_COMMAND						(SM_APP_MESSAGE + 10)
#define SM_APP_DEBUGCMD_EXEC						(SM_APP_MESSAGE + 11)
#define SM_APP_DEBUG_OUTPUT							(SM_APP_MESSAGE + 12)
#define SM_APP_DEBUGCMD_NOREPLY						(SM_APP_MESSAGE + 13)
...
#define TRACE_FORMAT									DebugLogger::getDebugLogger().traceErrorFormat
#define TRACE_ERROR(logString)							DebugLogger::getDebugLogger().traceError(logString)
#define TRACE_DEBUG(func, file, line)					DebugLogger::getDebugLogger().traceDebugInfo(func, file, line)
