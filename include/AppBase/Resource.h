...
#define VERSION_DIGITAL_VALUE 							3, 2, 1, 1
...
#define IDC_PWRREMINDER_MSGSTYLE_CUSTOMIZATION_TITLE	(CONTROLID_PWRREMINDER_DLG+29)
#define IDC_PWRREMINDER_MSGSTYLE_USECOMMON_RADBTN		(CONTROLID_PWRREMINDER_DLG+30)
#define IDC_PWRREMINDER_MSGSTYLE_USECUSTOM_RADBTN		(CONTROLID_PWRREMINDER_DLG+31)
#define IDC_PWRREMINDER_MSGSTYLE_CUSTOMIZE_BTN			(CONTROLID_PWRREMINDER_DLG+32)
...
//**************** Control resource IDs for RmdMsgStyleSetDlg dialog *********************

#define CONTROLID_MSGSTYLESET_DLG						(RESOURCEID_CONTROL+1200)
#define IDC_MSGSTYLESET_BKGRDCLR_TITLE			        (CONTROLID_MSGSTYLESET_DLG+1)
#define IDC_MSGSTYLESET_BKGRDCLR_PICKER			        (CONTROLID_MSGSTYLESET_DLG+2)
#define IDC_MSGSTYLESET_TEXTCLR_TITLE			        (CONTROLID_MSGSTYLESET_DLG+3)
#define IDC_MSGSTYLESET_TEXTCLR_PICKER			        (CONTROLID_MSGSTYLESET_DLG+4)
#define IDC_MSGSTYLESET_FONTSET_TITLE					(CONTROLID_MSGSTYLESET_DLG+5)
#define IDC_MSGSTYLESET_FONTNAME_COMBO					(CONTROLID_MSGSTYLESET_DLG+6)
#define IDC_MSGSTYLESET_FONTSIZE_COMBO				    (CONTROLID_MSGSTYLESET_DLG+7)
#define IDC_MSGSTYLESET_ICONID_TITLE         			(CONTROLID_MSGSTYLESET_DLG+8)
#define IDC_MSGSTYLESET_ICONID_COMBO         			(CONTROLID_MSGSTYLESET_DLG+9)
#define IDC_MSGSTYLESET_ICONSIZE_TITLE       			(CONTROLID_MSGSTYLESET_DLG+10)
#define IDC_MSGSTYLESET_ICONSIZE_EDIT       			(CONTROLID_MSGSTYLESET_DLG+11)
#define IDC_MSGSTYLESET_MSGICON_VIEW       				(CONTROLID_MSGSTYLESET_DLG+12)
#define IDC_MSGSTYLESET_ICONPOS_TITLE       			(CONTROLID_MSGSTYLESET_DLG+13)
#define IDC_MSGSTYLESET_ICONPOS_TOP_RAD    				(CONTROLID_MSGSTYLESET_DLG+14)
#define IDC_MSGSTYLESET_ICONPOS_LEFT_RAD   				(CONTROLID_MSGSTYLESET_DLG+15)
#define IDC_MSGSTYLESET_TIMEOUT_TITLE         			(CONTROLID_MSGSTYLESET_DLG+16)
#define IDC_MSGSTYLESET_TIMEOUT_EDIT         			(CONTROLID_MSGSTYLESET_DLG+17)
#define IDC_MSGSTYLESET_TIMEOUT_SPIN         			(CONTROLID_MSGSTYLESET_DLG+18)
#define IDC_MSGSTYLESET_TIMEOUT_UNIT         			(CONTROLID_MSGSTYLESET_DLG+19)
#define IDC_MSGSTYLESET_DISPLAYPOS_TITLE 				(CONTROLID_MSGSTYLESET_DLG+20)
#define IDC_MSGSTYLESET_DISPLAYPOS_COMBO 				(CONTROLID_MSGSTYLESET_DLG+21)
#define IDC_MSGSTYLESET_HMARGIN_TITLE		        	(CONTROLID_MSGSTYLESET_DLG+22)
#define IDC_MSGSTYLESET_HMARGIN_EDIT		        	(CONTROLID_MSGSTYLESET_DLG+23)
#define IDC_MSGSTYLESET_HMARGIN_UNIT		        	(CONTROLID_MSGSTYLESET_DLG+24)
#define IDC_MSGSTYLESET_VMARGIN_TITLE        			(CONTROLID_MSGSTYLESET_DLG+25)
#define IDC_MSGSTYLESET_VMARGIN_EDIT		        	(CONTROLID_MSGSTYLESET_DLG+26)
#define IDC_MSGSTYLESET_VMARGIN_UNIT		        	(CONTROLID_MSGSTYLESET_DLG+27)
#define IDC_MSGSTYLESET_PREVIEW_BTN         			(CONTROLID_MSGSTYLESET_DLG+28)
#define IDC_MSGSTYLESET_RESET_BTN           			(CONTROLID_MSGSTYLESET_DLG+29)
#define IDC_MSGSTYLESET_APPLY_BTN         				(CONTROLID_MSGSTYLESET_DLG+30)
#define IDC_MSGSTYLESET_CANCEL_BTN           			(CONTROLID_MSGSTYLESET_DLG+31)
...
#define CONTROLID_DEBUGTEST_DLG							(RESOURCEID_CONTROL+1300)
