...
#define IDC_PWRREMINDER_MSGSTYLE_CUSTOMIZE_TITLE		(CONTROLID_PWRREMINDER_DLG+29)
#define IDC_PWRREMINDER_MSGSTYLE_USEGLOBAL_RADBTN		(CONTROLID_PWRREMINDER_DLG+30)
