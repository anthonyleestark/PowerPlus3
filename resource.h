...
#define IDS_APP_CURRENT_INSTANCE 	              		101
...
#define IDR_MENU_DEBUGTEST_EDITVIEW						201
...
#define IDM_DEBUGTEST_PASTE								(MENUID_DEBUGTEST_DLG+2)
#define IDM_DEBUGTEST_DISP_PREVCOMMAND					(MENUID_DEBUGTEST_DLG+3)
#define IDM_DEBUGTEST_DISP_NEXTCOMMAND					(MENUID_DEBUGTEST_DLG+4)
#define IDM_DEBUGTEST_CLEAR_BUFFER                 		(MENUID_DEBUGTEST_DLG+5)
#define IDM_DEBUGTEST_CLOSE								(MENUID_DEBUGTEST_DLG+6)


// Define item resource IDs for notify menu
//

#define IDC_MENU_TITLE                  				(RESOURCEID_CONTROL+1300)
...
//		  3. From 1000 - 1999	: Registry key strings
//		  4. From 2000 - 9999	: Other resource strings
//
//////////////////////////////////////////////////////////////////////////////////
...
#define IDS_APP_REGISTRY_HKEY							(STRINGID_APP_BASIC+4)
#define IDS_APP_REGISTRY_SUBKEYPATH						(STRINGID_APP_BASIC+5)
#define IDS_APP_REGISTRY_PROFILENAME					(STRINGID_APP_BASIC+6)
#define IDS_APP_REGISTRY_APPNAME						(STRINGID_APP_BASIC+7)
#define IDS_APP_REGISTRY_PATH							(STRINGID_APP_BASIC+8)


// Define string resource IDs for registry sections
//

#define STRINGID_REGSECTION								(RESOURCEID_STRING+200)
#define IDS_REGSECTION_AUTOSTART						(STRINGID_REGSECTION+1)
#define IDS_REGSECTION_CONFIG           				(STRINGID_REGSECTION+2)
#define IDS_REGSECTION_SCHEDULE         				(STRINGID_REGSECTION+3)
#define IDS_REGSECTION_SCHEDITEMID						(STRINGID_REGSECTION+4)
#define IDS_REGSECTION_HOTKEYSET						(STRINGID_REGSECTION+5)
#define IDS_REGSECTION_HKEYITEMID						(STRINGID_REGSECTION+6)
#define IDS_REGSECTION_PWRREMINDER						(STRINGID_REGSECTION+7)
#define IDS_REGSECTION_PWRRMDITEMID						(STRINGID_REGSECTION+8)
#define IDS_REGSECTION_GLBDATA							(STRINGID_REGSECTION+9)
#define IDS_REGSECTION_GLBDATA_DEBUGTEST				(STRINGID_REGSECTION+10)
#define IDS_REGSECTION_GLBDATA_APPFLAGS					(STRINGID_REGSECTION+11)
#define IDS_REGSECTION_GLBDATA_FEATURES					(STRINGID_REGSECTION+12)
#define IDS_REGSECTION_GLBDATA_TRACKING					(STRINGID_REGSECTION+13)
#define IDS_REGSECTION_GLBDATA_OTHERS					(STRINGID_REGSECTION+14)
#define IDS_REGSECTION_LAYOUTINFO						(STRINGID_REGSECTION+15)
#define IDS_REGSECTION_LAYOUT_LGVWRTABLE				(STRINGID_REGSECTION+16)
#define IDS_REGSECTION_LAYOUT_LOGDETAILPROPS			(STRINGID_REGSECTION+17)
#define IDS_REGSECTION_LAYOUT_LOGDETAILDATA				(STRINGID_REGSECTION+18)
#define IDS_REGSECTION_LAYOUT_MULTISCHEDULE				(STRINGID_REGSECTION+19)
#define IDS_REGSECTION_LAYOUT_HKEYSETTABLE				(STRINGID_REGSECTION+20)
#define IDS_REGSECTION_LAYOUT_PWRREMINDERTABLE			(STRINGID_REGSECTION+21)


// Define string resource IDs for registry keys
//

#define STRINGID_REGKEY									(RESOURCEID_STRING+1000)
#define STRINGID_REGKEY_PROFILE							(STRINGID_REGKEY+100)
#define STRINGID_REGKEY_CONFIG							(STRINGID_REGKEY+200)
#define STRINGID_REGKEY_APPDATA							(STRINGID_REGKEY+300)
#define STRINGID_REGKEY_GLBDATA							(STRINGID_REGKEY+400)

// Profile registry keys
#define IDS_REGKEY_PROFILE_LAUNCHTIME					(STRINGID_REGKEY_PROFILE+1)
#define IDS_REGKEY_PROFILE_LAUNCHCOUNTER				(STRINGID_REGKEY_PROFILE+2)
#define IDS_REGKEY_PROFILE_DIRECTORY					(STRINGID_REGKEY_PROFILE+3)
#define IDS_REGKEY_PROFILE_FILENAME						(STRINGID_REGKEY_PROFILE+4)
#define IDS_REGKEY_PROFILE_PRODUCTVERSION				(STRINGID_REGKEY_PROFILE+5)
#define IDS_REGKEY_PROFILE_USERNAME						(STRINGID_REGKEY_PROFILE+6)
#define IDS_REGKEY_PROFILE_DEVICENAME					(STRINGID_REGKEY_PROFILE+7)
#define IDS_REGKEY_PROFILE_OSVERSION					(STRINGID_REGKEY_PROFILE+8)
#define IDS_REGKEY_PROFILE_OSBUILDNUMBER				(STRINGID_REGKEY_PROFILE+9)
#define IDS_REGKEY_PROFILE_OSPLATFORMID					(STRINGID_REGKEY_PROFILE+10)

// Configuration registry keys
#define IDS_REGKEY_CFG_ACTIONLMB        				(STRINGID_REGKEY_CONFIG+1)
#define IDS_REGKEY_CFG_ACTIONMMB        				(STRINGID_REGKEY_CONFIG+2)
#define IDS_REGKEY_CFG_ACTIONRMB        				(STRINGID_REGKEY_CONFIG+3)
#define IDS_REGKEY_CFG_LANGUAGEID       				(STRINGID_REGKEY_CONFIG+4)
#define IDS_REGKEY_CFG_RMBSHOWMENU      				(STRINGID_REGKEY_CONFIG+5)
#define IDS_REGKEY_CFG_SHOWATSTARTUP    				(STRINGID_REGKEY_CONFIG+6)
#define IDS_REGKEY_CFG_STARTUPENABLE    				(STRINGID_REGKEY_CONFIG+7)
#define IDS_REGKEY_CFG_CONFIRMACTION    				(STRINGID_REGKEY_CONFIG+8)
#define IDS_REGKEY_CFG_SAVEACTIONLOG    				(STRINGID_REGKEY_CONFIG+9)
#define IDS_REGKEY_CFG_SAVEAPPEVENTLOG  			  	(STRINGID_REGKEY_CONFIG+10)
#define IDS_REGKEY_CFG_RUNASADMIN						(STRINGID_REGKEY_CONFIG+11)
#define IDS_REGKEY_CFG_SHOWERROR        				(STRINGID_REGKEY_CONFIG+12)
#define IDS_REGKEY_CFG_SCHEDULENOTIFY   				(STRINGID_REGKEY_CONFIG+13)
#define IDS_REGKEY_CFG_SCHEDALLOWCANCEL 				(STRINGID_REGKEY_CONFIG+14)
#define IDS_REGKEY_CFG_ENBBKGRDHOTKEYS					(STRINGID_REGKEY_CONFIG+15)
#define IDS_REGKEY_CFG_LOCKSTATEHOTKEY					(STRINGID_REGKEY_CONFIG+16)
#define IDS_REGKEY_CFG_ENBPWRREMINDER					(STRINGID_REGKEY_CONFIG+17)
#define IDS_REGKEY_CFG_DISPTOOLTIP						(STRINGID_REGKEY_CONFIG+18)
#define IDS_REGKEY_CFG_AUTOUPDATE						(STRINGID_REGKEY_CONFIG+19)

// Application data registry keys
#define IDS_REGKEY_SCHEDULE_ITEMNUM						(STRINGID_REGKEY_APPDATA+1)
#define IDS_REGKEY_SCHEDULE_ITEMID						(STRINGID_REGKEY_APPDATA+2)
#define IDS_REGKEY_SCHEDULE_ENABLE      				(STRINGID_REGKEY_APPDATA+3)
#define IDS_REGKEY_SCHEDULE_TIMEVALUE           		(STRINGID_REGKEY_APPDATA+4)
#define IDS_REGKEY_SCHEDULE_ACTION         				(STRINGID_REGKEY_APPDATA+5)
#define IDS_REGKEY_SCHEDULE_REPEAT         				(STRINGID_REGKEY_APPDATA+6)
#define IDS_REGKEY_SCHEDULE_REPEATDAYS					(STRINGID_REGKEY_APPDATA+7)
#define IDS_REGKEY_HKEYSET_ITEMNUM						(STRINGID_REGKEY_APPDATA+8)
#define IDS_REGKEY_HKEYSET_ACTIONID						(STRINGID_REGKEY_APPDATA+9)
#define IDS_REGKEY_HKEYSET_ENABLE						(STRINGID_REGKEY_APPDATA+10)
#define IDS_REGKEY_HKEYSET_CTRLKEY						(STRINGID_REGKEY_APPDATA+11)
#define IDS_REGKEY_HKEYSET_FUNCKEY						(STRINGID_REGKEY_APPDATA+12)
#define IDS_REGKEY_PWRRMD_ITEMNUM						(STRINGID_REGKEY_APPDATA+13)
#define IDS_REGKEY_PWRRMD_ITEMID						(STRINGID_REGKEY_APPDATA+14)
#define IDS_REGKEY_PWRRMD_ENABLE						(STRINGID_REGKEY_APPDATA+15)
#define IDS_REGKEY_PWRRMD_MSGSTRING						(STRINGID_REGKEY_APPDATA+16)
#define IDS_REGKEY_PWRRMD_EVENTID						(STRINGID_REGKEY_APPDATA+17)
#define IDS_REGKEY_PWRRMD_TIMEVALUE						(STRINGID_REGKEY_APPDATA+18)
#define IDS_REGKEY_PWRRMD_MSGSTYLE						(STRINGID_REGKEY_APPDATA+19)
#define IDS_REGKEY_PWRRMD_REPEAT						(STRINGID_REGKEY_APPDATA+20)
#define IDS_REGKEY_PWRRMD_ALLOWSNOOZE					(STRINGID_REGKEY_APPDATA+21)
#define IDS_REGKEY_PWRRMD_SNOOZEINTERVAL				(STRINGID_REGKEY_APPDATA+22)
#define IDS_REGKEY_PWRRMD_REPEATDAYS					(STRINGID_REGKEY_APPDATA+23)

// Global data registry keys
#define IDS_REGKEY_LAYOUT_GRIDCOLUMNSIZE				(STRINGID_REGKEY_GLBDATA+1)	
#define IDS_REGKEY_APPFLAG_PWRACTIONFLG					(STRINGID_REGKEY_GLBDATA+2)
#define IDS_REGKEY_APPFLAG_SYSTEMSUSPENDFLG				(STRINGID_REGKEY_GLBDATA+3)
#define IDS_REGKEY_APPFLAG_SESSIONENDFLAG				(STRINGID_REGKEY_GLBDATA+4)
#define IDS_REGKEY_APPFLAG_SAFETERMINATION				(STRINGID_REGKEY_GLBDATA+5)
#define IDS_REGKEY_TRACKING_LASTSYSSUSPEND				(STRINGID_REGKEY_GLBDATA+6)
#define IDS_REGKEY_TRACKING_LASTSYSWAKEUP				(STRINGID_REGKEY_GLBDATA+7)
#define IDS_REGKEY_TRACKING_LASTSESSIONEND				(STRINGID_REGKEY_GLBDATA+8)
#define IDS_REGKEY_FEATURE_RMDMSG_BKGRDCLR				(STRINGID_REGKEY_GLBDATA+9)
#define IDS_REGKEY_FEATURE_RMDMSG_TXTCLR				(STRINGID_REGKEY_GLBDATA+10)
#define IDS_REGKEY_FEATURE_RMDMSG_FONTNAME				(STRINGID_REGKEY_GLBDATA+11)
#define IDS_REGKEY_FEATURE_RMDMSG_FONTSIZE				(STRINGID_REGKEY_GLBDATA+12)
#define IDS_REGKEY_FEATURE_RMDMSG_TIMEOUT				(STRINGID_REGKEY_GLBDATA+13)
#define IDS_REGKEY_FEATURE_RMDMSG_ICONID				(STRINGID_REGKEY_GLBDATA+14)
#define IDS_REGKEY_FEATURE_RMDMSG_ICONSIZE				(STRINGID_REGKEY_GLBDATA+15)
#define IDS_REGKEY_FEATURE_RMDMSG_ICONPOS				(STRINGID_REGKEY_GLBDATA+16)
#define IDS_REGKEY_FEATURE_RMDMSG_MSGDISPPOS			(STRINGID_REGKEY_GLBDATA+17)
#define IDS_REGKEY_FEATURE_RMDMSG_HMARGIN				(STRINGID_REGKEY_GLBDATA+18)
#define IDS_REGKEY_FEATURE_RMDMSG_VMARGIN				(STRINGID_REGKEY_GLBDATA+19)
#define IDS_REGKEY_FEATURE_RMDMSG_SNOOZETIME			(STRINGID_REGKEY_GLBDATA+20)
#define IDS_REGKEY_DBTEST_DUMMYTEST						(STRINGID_REGKEY_GLBDATA+21)
#define IDS_REGKEY_DBTEST_DEBUGMODE						(STRINGID_REGKEY_GLBDATA+22)
#define IDS_REGKEY_DBTEST_DBLOGOUTPUT					(STRINGID_REGKEY_GLBDATA+23)
#define IDS_REGKEY_DBTEST_TESTFEATURE					(STRINGID_REGKEY_GLBDATA+24)


// Define string resource IDs for logging
//

#define STRINGID_LOGGING								(RESOURCEID_STRING+2000)
#define IDS_HISTORYLOG_PWRACTION_TEMPLATE				(STRINGID_LOGGING+1)
#define IDS_HISTORYLOG_PWRACTION_DONOTHING				(STRINGID_LOGGING+2)
#define IDS_HISTORYLOG_PWRACTION_DISPLAYOFF				(STRINGID_LOGGING+3)
#define IDS_HISTORYLOG_PWRACTION_SLEEP					(STRINGID_LOGGING+4)
#define IDS_HISTORYLOG_PWRACTION_SHUTDOWN				(STRINGID_LOGGING+5)
#define IDS_HISTORYLOG_PWRACTION_RESTART				(STRINGID_LOGGING+6)
#define IDS_HISTORYLOG_PWRACTION_SIGNOUT				(STRINGID_LOGGING+7)
#define IDS_HISTORYLOG_PWRACTION_HIBERNATE				(STRINGID_LOGGING+8)
#define IDS_HISTORYLOG_SCHEDULE_TEMPLATE				(STRINGID_LOGGING+9)
#define IDS_HISTORYLOG_HOTKEYSET_TEMPLATE				(STRINGID_LOGGING+10)
#define IDS_HISTORYLOG_PWRREMINDER_TEMPLATE				(STRINGID_LOGGING+11)
#define IDS_HISTORYLOG_RESULT_SUCCESS					(STRINGID_LOGGING+12)
#define IDS_HISTORYLOG_RESULT_FAILED_UNKNOWN			(STRINGID_LOGGING+13)
#define IDS_HISTORYLOG_RESULT_FAILED_ERRCODE			(STRINGID_LOGGING+14)


// Define string resource IDs for others
//

#define STRINGID_OTHER									(RESOURCEID_STRING+2100)
...
// 	These macros are auto-generated by Visual C++
// 	Used by Visual Studio resource designer
// 	Modified by Anthony Lee Stark (no longer used)
//
//////////////////////////////////////////////////////////
...
#define _APS_NEXT_COMMAND_VALUE        			30510
